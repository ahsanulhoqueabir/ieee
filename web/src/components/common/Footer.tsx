...
const Footer = () => {
  ...
  return (
    <>
      <footer className="footer bg-teal-600 text-teal-50 lg:flex gap-20 justify-between p-10 mb-16 lg:mb-0 ">
        <aside className="w-full">
          ...
          <p className="text-justify">
            ...
            community of technology leaders that includes researchers,
      ...
      <p className="text-xs bg-teal-600 py-6 text-center text-white">
        &copy; {year}{" "}
        <a href="https://www.linkedin.com/in/AhsanulHoqueAbir">Ahsanul Hoque</a>
        . All rights reserved.
      </p>
    </>
  );
